namespace LibraryManagementSystem.LibraryPresentationLayer
{
    partial class AdminForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button4
            // 
            button4.Location = new Point(525, 17);
            button4.Margin = new Padding(3, 2, 3, 2);
            button4.Name = "button4";
            button4.Size = new Size(153, 22);
            button4.TabIndex = 5;
            ...
            // button1
            // 
            button1.Location = new Point(242, 58);
            ...
            // ExcelExport
            // 
            ExcelExport.Location = new Point(36, 58);
            ExcelExport.Margin = new Padding(3, 2, 3, 2);
            ExcelExport.Name = "ExcelExport";
            ExcelExport.Size = new Size(141, 22);
            ...
            dgv_Report.Location = new Point(0, 93);
            dgv_Report.Margin = new Padding(3, 2, 3, 2);
            dgv_Report.Name = "dgv_Report";
            dgv_Report.RowHeadersWidth = 51;
            dgv_Report.Size = new Size(826, 329);
